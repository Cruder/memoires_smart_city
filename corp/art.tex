...
La production d'énergie et sa consommation 
La quantité de Gaz à Effet de Serre - GES - dans l'atmosphère s'en retrouve directement impacté. 
Elle est responsable de l'augmentation de la température terrestre. 
% Estimation de l'emprunte carbone du numérique
% Augmentation des températures
% Augmentation des catastrophes naturelles
% Montée des eaux, affaissement des océans
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.5]{media/repartition_ges.png}
  \caption{
      \tiny{Source:
        \url{https://img.aws.la-croix.com/2019/05/29/1301025438/Production-reserves-metaux-rares_1_728_388.jpg}
      }
...
La technologie est en constante progression depuis toujours et sont de plus en plus puissantes.
