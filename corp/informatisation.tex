...
\begin{itemize}
  \item Le matériel Hardware qui est au centre de toutes les communication.
  ...
  \item Les bases de données bien plus nombreuses peuvent être altéré.
        Ces données représentent la réalité et doit rester la plus intègre que possible.
  \item Les logiciels utilisant ces données sont sensible a différents vecteurs tel que le
        phishing des comptes administrateur et les failles logicielles Software.
  \item Les prises de décisions humaines peuvent être mis en péril avec de l'ingénierie sociale.
        Cela dans un but politique de la ville ou bien d'attaque terroriste.
\end{itemize}

Ces quatre facteurs déjà présent dans la ville d'aujourd'hui serons bien plus mis en avant avec
les réseaux intelligent.
